...
<main class="p-4 md:ml-64 h-auto pt-6">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
        <div class="bg-gray-50 dark:bg-gray-800 border-4 border-dashed border-gray-200 dark:border-gray-700 rounded-lg h-32 md:h-64 text-center">
            <div class="text-blue-500 dark:text-white mt-4 md:block flex items-center mx-auto p-2">
                <h2 class="font-bold text-center md:mr-0 mr-4">
                ...
                <h1 class="font-bold md:mr-0 mr-4">Total :</h1>
                <div>
                    <h1  style="font-family: 'Audiowide', serif;" class="text-6xl font-bold md:mr-0 mr-4">
                        <?= $mahasiswa ?> 
                    </h1>
        ...
        <div class="bg-gray-50 dark:bg-gray-800 border-4 border-dashed border-gray-200 dark:border-gray-700 rounded-lg h-32 md:h-64 text-center">
            <div class="text-green-500 dark:text-white mt-4 md:block flex items-center mx-auto p-2">
                <h2 class="font-bold text-center md:mr-0 mr-4">
                 <svg class="w-20 h-20 mx-auto block" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div class="bg-gray-50 dark:bg-gray-800 border-4 border-dashed border-gray-200 dark:border-gray-700 rounded-lg h-32 md:h-64 text-center">
            <div class="text-indigo-500 dark:text-white mt-4 md:block flex items-center mx-auto p-2">
                <h2 class="font-bold text-center md:mr-0 mr-4">
                 <svg class="w-20 h-20 mx-auto block" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div class="bg-gray-50 dark:bg-gray-800 border-4 border-dashed border-gray-200 dark:border-gray-700 rounded-lg h-32 md:h-64 text-center">
            <div class="text-red-500 dark:text-white mt-4 md:block flex items-center mx-auto p-2">
                <h2 class="font-bold text-center md:mr-0 mr-4 md:pb-4">
