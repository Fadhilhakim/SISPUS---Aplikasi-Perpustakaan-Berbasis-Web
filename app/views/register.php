...
<form class="max-w-sm mx-auto dark:bg-gray-900 bg-gray-200 p-5" action="/register/register" method="post">
  ...
  <div class="mb-5">
    ...
    <input type="password" id="confirm_password" name="confirm_password" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm  focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " required />
  </div>
